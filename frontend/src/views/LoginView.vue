    ...
    >
      ...
      <div class="flex flex-col gap-4">
        <a
          ...
          class="inline-flex items-center justify-center w-full px-4 py-2 rounded-md text-sm font-medium bg-blue-700 text-white hover:bg-blue-800 transition-colors"
        >
          Sign in with Google
        </a>
      </div>
