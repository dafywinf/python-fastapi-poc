  ...
  <div class="flex flex-col gap-4">
    <div class="flex flex-col gap-1">
      ...
      <InputText
        ...
        required
      />
      <small v-if="errors?.name" data-testid="form-name-error" class="text-red-600">{{ errors.name }}</small>
    </div>
    ...
    <div v-if="scheduleTypeModel === 'cron'" data-testid="form-cron-field" class="flex flex-col gap-1">
    ...
    <div v-if="scheduleTypeModel === 'interval'" data-testid="form-interval-field" class="flex flex-col gap-1">
      <label
